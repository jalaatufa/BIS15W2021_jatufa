...
```
## Warning in min(life_expectancy, na.rm = T): min 中沒有無漏失的引數; 回傳 Inf
...
```
## Warning in max(life_expectancy, na.rm = T): max 中沒有無漏失的引數；回傳 -Inf
...
## $ year            <chr> "1920", "1921", "1922", "1923", "1924", "1925", "1926"~
## $ life_expectancy <dbl> 30.6, 30.7, 30.8, 30.8, 30.9, 31.0, 31.0, 31.1, 31.1, ~
## $ population      <dbl> 10600000, 10500000, 10300000, 9710000, 9200000, 872000~
## $ income          <dbl> 1490, 1520, 1550, 1570, 1600, 1630, 1650, 1680, 1710, ~
```
