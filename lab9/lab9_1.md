...
## Data Types
We first need to define some of the data types we will use to build plots.  - plots might only wokr with some kinds of data :
...
## # ... with 14 more rows
```
^helps find the proportion of mission data
...
always include a table with your bar graph
...
pulls out the lowest 10 on the category using "top_n(-)"
...
reorder() function makes the plot look better
