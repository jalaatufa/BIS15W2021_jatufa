...
## 3 Torgersen              NA     52
```
summarize () is intolerant of NAs - must be removed - 
...
## 3 Torgersen    52
```
count is the same as summarize() and group_by() - 
...
reversing the order changes that first colomn
...
#  summarise(mean_bill_length=mean(bill_length_mm), mean_bill_depth=mean(bill_depth_mm), mean_
```
