...
R is a program used for coding project largley in the biological science and R Studio is a program that greatky enhances R's features - making it more user friendly.
