...
view(sydneybeaches)
```
The data are tidy and in a long format - we can tell they are tidy because none of the column names are variables, each variable has its own column, and observations get their own row. 
